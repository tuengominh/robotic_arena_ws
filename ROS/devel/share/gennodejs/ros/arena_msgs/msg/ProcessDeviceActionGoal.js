...
class ProcessDeviceActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new ProcessDeviceGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ProcessDeviceGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ProcessDeviceActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = ProcessDeviceGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ProcessDeviceGoal.getMessageSize(object.goal);
    return length;
  }

  static datatype() {
    // Returns string type for a message object
    return 'arena_msgs/ProcessDeviceActionGoal';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '8eb4df7f7c7ca7d9a697f856df4225ec';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ProcessDeviceActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ProcessDeviceGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ProcessDeviceGoal()
    }
...
module.exports = ProcessDeviceActionGoal;
