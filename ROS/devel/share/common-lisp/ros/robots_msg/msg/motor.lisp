...
(cl:defmethod cl:initialize-instance :after ((m <motor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robots_msg-msg:<motor> is deprecated: use robots_msg-msg:motor instead.")))
...
(cl:defmethod dir-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robots_msg-msg:dir-val is deprecated.  Use robots_msg-msg:dir instead.")
  (dir m))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robots_msg-msg:pos-val is deprecated.  Use robots_msg-msg:pos instead.")
  (pos m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<motor>)))
  ...
  (cl:format cl:nil "uint8 speed  # 0..255 for ecology20 and 0..180 for tanke20~%uint8 dir  # 0 : stop, 1 : CW, 2 : CCW~%int16 pos  # position ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'motor)))
  "Returns full string definition for message of type 'motor"
  (cl:format cl:nil "uint8 speed  # 0..255 for ecology20 and 0..180 for tanke20~%uint8 dir  # 0 : stop, 1 : CW, 2 : CCW~%int16 pos  # position ~%~%~%"))
