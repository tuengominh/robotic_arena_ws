...
(cl:defclass <armpap_msgs> (roslisp-msg-protocol:ros-message)
  ((type
    :reader type
    :initarg :type
    :type cl:string
...
(cl:defclass armpap_msgs (<armpap_msgs>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <armpap_msgs>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'armpap_msgs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robots_msg-msg:<armpap_msgs> is deprecated: use robots_msg-msg:armpap_msgs instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <armpap_msgs>))
...
(cl:defmethod ip-val ((m <armpap_msgs>))
...
(cl:defmethod port-val ((m <armpap_msgs>))
...
(cl:defmethod id-val ((m <armpap_msgs>))
...
(cl:defmethod inst_before-val ((m <armpap_msgs>))
...
(cl:defmethod base_speed-val ((m <armpap_msgs>))
...
(cl:defmethod base_target-val ((m <armpap_msgs>))
...
(cl:defmethod base_current-val ((m <armpap_msgs>))
...
(cl:defmethod left_speed-val ((m <armpap_msgs>))
...
(cl:defmethod left_target-val ((m <armpap_msgs>))
...
(cl:defmethod left_current-val ((m <armpap_msgs>))
...
(cl:defmethod right_speed-val ((m <armpap_msgs>))
...
(cl:defmethod right_target-val ((m <armpap_msgs>))
...
(cl:defmethod right_current-val ((m <armpap_msgs>))
...
(cl:defmethod color-val ((m <armpap_msgs>))
...
(cl:defmethod gripper-val ((m <armpap_msgs>))
...
(cl:defmethod status-val ((m <armpap_msgs>))
  ...
  (status m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <armpap_msgs>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <armpap_msgs>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<armpap_msgs>)))
  "Returns string type for a message object of type '<armpap_msgs>"
  "robots_msg/armpap_msgs")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'armpap_msgs)))
  "Returns string type for a message object of type 'armpap_msgs"
  "robots_msg/armpap_msgs")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<armpap_msgs>)))
  "Returns md5sum for a message object of type '<armpap_msgs>"
  "040948e8a15d597e107b2f1c93f40e51")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'armpap_msgs)))
  "Returns md5sum for a message object of type 'armpap_msgs"
  "040948e8a15d597e107b2f1c93f40e51")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<armpap_msgs>)))
  "Returns full string definition for message of type '<armpap_msgs>"
  (cl:format cl:nil "string type  # type of robot ”ARMPAP”~%string ip  # address of the robot ESP8866~%uint32 port  # port for comunication~%uint8 id  # uint8_t id of the robot ~%uint8 inst_before  # the last instruction runner ~%uint16 base_speed  # base speed~%int16 base_target  # base target position~%int16 base_current  # base current position~%uint16 left_speed  # left speed ~%int16 left_target  # left target position~%int16 left_current  # left current position~%uint16 right_speed  # right speed~%int16 right_target  # right target position~%int16 right_current  # right current position~%uint8 color  # color of the light 0..17~%uint8 gripper  # 0 : open, 1 : close~%string status  # \"Completed\" or \"Error type 3\"~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'armpap_msgs)))
  "Returns full string definition for message of type 'armpap_msgs"
  (cl:format cl:nil "string type  # type of robot ”ARMPAP”~%string ip  # address of the robot ESP8866~%uint32 port  # port for comunication~%uint8 id  # uint8_t id of the robot ~%uint8 inst_before  # the last instruction runner ~%uint16 base_speed  # base speed~%int16 base_target  # base target position~%int16 base_current  # base current position~%uint16 left_speed  # left speed ~%int16 left_target  # left target position~%int16 left_current  # left current position~%uint16 right_speed  # right speed~%int16 right_target  # right target position~%int16 right_current  # right current position~%uint8 color  # color of the light 0..17~%uint8 gripper  # 0 : open, 1 : close~%string status  # \"Completed\" or \"Error type 3\"~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <armpap_msgs>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <armpap_msgs>))
