...
(cl:defmethod cl:initialize-instance :after ((m <DiscreteAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DiscreteAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robots_msg-msg:<DiscreteAction> is deprecated: use robots_msg-msg:DiscreteAction instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DiscreteAction>)))
  ...
  (cl:format cl:nil "# Provide information about the type of action the robot will perform~%string robot_id # robot id~%string action # discrete action~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DiscreteAction)))
  "Returns full string definition for message of type 'DiscreteAction"
  (cl:format cl:nil "# Provide information about the type of action the robot will perform~%string robot_id # robot id~%string action # discrete action~%~%~%"))
