...
(cl:defmethod cl:initialize-instance :after ((m <eco_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'eco_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robots_msg-msg:<eco_msg> is deprecated: use robots_msg-msg:eco_msg instead.")))
...
(cl:defmethod tempe-val ((m <eco_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robots_msg-msg:tempe-val is deprecated.  Use robots_msg-msg:tempe instead.")
  (tempe m))

(cl:ensure-generic-function 'line0-val :lambda-list '(m))
(cl:defmethod line0-val ((m <eco_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robots_msg-msg:line0-val is deprecated.  Use robots_msg-msg:line0 instead.")
  (line0 m))

(cl:ensure-generic-function 'line1-val :lambda-list '(m))
(cl:defmethod line1-val ((m <eco_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robots_msg-msg:line1-val is deprecated.  Use robots_msg-msg:line1 instead.")
  (line1 m))
