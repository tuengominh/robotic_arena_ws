...
(cl:defmethod cl:initialize-instance :after ((m <camera>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arena_msgs-msg:<camera> is deprecated: use arena_msgs-msg:camera instead.")))

(cl:ensure-generic-function 'detect-val :lambda-list '(m))
(cl:defmethod detect-val ((m <camera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:detect-val is deprecated.  Use arena_msgs-msg:detect instead.")
  (detect m))
...
(cl:defmethod targx-val ((m <camera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:targx-val is deprecated.  Use arena_msgs-msg:targx instead.")
  (targx m))

(cl:ensure-generic-function 'targy-val :lambda-list '(m))
(cl:defmethod targy-val ((m <camera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:targy-val is deprecated.  Use arena_msgs-msg:targy instead.")
  (targy m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <camera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:data-val is deprecated.  Use arena_msgs-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<camera>)))
  ...
  (cl:format cl:nil "int8 detect # 1 detect 0 non detect    ~%uint8 id    # number of fiducial~%int16 targx # coordinate x~%int16 targy # coordinate y~%string data # all info in string~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'camera)))
  "Returns full string definition for message of type 'camera"
  (cl:format cl:nil "int8 detect # 1 detect 0 non detect    ~%uint8 id    # number of fiducial~%int16 targx # coordinate x~%int16 targy # coordinate y~%string data # all info in string~%~%"))
