...
(cl:defmethod cl:initialize-instance :after ((m <cmd_robot_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cmd_robot_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arena_msgs-msg:<cmd_robot_msg> is deprecated: use arena_msgs-msg:cmd_robot_msg instead.")))
...
(cl:defmethod instruction-val ((m <cmd_robot_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:instruction-val is deprecated.  Use arena_msgs-msg:instruction instead.")
  (instruction m))

(cl:ensure-generic-function 'op1-val :lambda-list '(m))
(cl:defmethod op1-val ((m <cmd_robot_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:op1-val is deprecated.  Use arena_msgs-msg:op1 instead.")
  (op1 m))

(cl:ensure-generic-function 'op2-val :lambda-list '(m))
(cl:defmethod op2-val ((m <cmd_robot_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:op2-val is deprecated.  Use arena_msgs-msg:op2 instead.")
  (op2 m))

(cl:ensure-generic-function 'op3-val :lambda-list '(m))
(cl:defmethod op3-val ((m <cmd_robot_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:op3-val is deprecated.  Use arena_msgs-msg:op3 instead.")
  (op3 m))

(cl:ensure-generic-function 'op4-val :lambda-list '(m))
(cl:defmethod op4-val ((m <cmd_robot_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:op4-val is deprecated.  Use arena_msgs-msg:op4 instead.")
  (op4 m))

(cl:ensure-generic-function 'op5-val :lambda-list '(m))
(cl:defmethod op5-val ((m <cmd_robot_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:op5-val is deprecated.  Use arena_msgs-msg:op5 instead.")
  (op5 m))
