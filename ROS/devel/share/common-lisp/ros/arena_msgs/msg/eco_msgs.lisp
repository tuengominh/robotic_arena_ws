...
(cl:defclass <eco_msgs> (roslisp-msg-protocol:ros-message)
  ((type
   ...
   (jevois
    :reader jevois
    :initarg :jevois
    :type arena_msgs-msg:camera
    :initform (cl:make-instance 'arena_msgs-msg:camera))
   (status
    :reader status
    :initarg :status
    :type cl:string
...
(cl:defmethod cl:initialize-instance :after ((m <eco_msgs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'eco_msgs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arena_msgs-msg:<eco_msgs> is deprecated: use arena_msgs-msg:eco_msgs instead.")))
...
(cl:defmethod range_l-val ((m <eco_msgs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:range_l-val is deprecated.  Use arena_msgs-msg:range_l instead.")
  (range_l m))

(cl:ensure-generic-function 'range_c-val :lambda-list '(m))
(cl:defmethod range_c-val ((m <eco_msgs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:range_c-val is deprecated.  Use arena_msgs-msg:range_c instead.")
  (range_c m))

(cl:ensure-generic-function 'range_r-val :lambda-list '(m))
(cl:defmethod range_r-val ((m <eco_msgs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:range_r-val is deprecated.  Use arena_msgs-msg:range_r instead.")
  (range_r m))

(cl:ensure-generic-function 'compas-val :lambda-list '(m))
(cl:defmethod compas-val ((m <eco_msgs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:compas-val is deprecated.  Use arena_msgs-msg:compas instead.")
  (compas m))

(cl:ensure-generic-function 'pos_motor1-val :lambda-list '(m))
(cl:defmethod pos_motor1-val ((m <eco_msgs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:pos_motor1-val is deprecated.  Use arena_msgs-msg:pos_motor1 instead.")
  (pos_motor1 m))

(cl:ensure-generic-function 'pos_motor2-val :lambda-list '(m))
(cl:defmethod pos_motor2-val ((m <eco_msgs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:pos_motor2-val is deprecated.  Use arena_msgs-msg:pos_motor2 instead.")
  (pos_motor2 m))

(cl:ensure-generic-function 'jevois-val :lambda-list '(m))
(cl:defmethod jevois-val ((m <eco_msgs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:jevois-val is deprecated.  Use arena_msgs-msg:jevois instead.")
  (jevois m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<eco_msgs>)))
  ...
  (cl:format cl:nil "string type # type of robot “ECOLOGY20”~%string ip # address of the robot ESP8866~%uint32 port # Port for comunication~%uint8 id # identyti of robot a uint8_t~%uint8 inst_before # the last instruction runner ~%float32 battery # % of the battery~%uint16 range_l # ir sensor~%uint16 range_c # laser sensor~%uint16 range_r # ir sensor ~%int16 compas   # heading~%int16 pos_motor1 # position motor left~%int16 pos_motor2 # position motor right ~%arena_msgs/camera jevois # Aruco info~%string status # \"Completed\" or \"Error tipo 1\"~%~%================================================================================~%MSG: arena_msgs/camera~%int8 detect # 1 detect 0 non detect    ~%uint8 id    # number of fiducial~%int16 targx # coordinate x~%int16 targy # coordinate y~%string data # all info in string~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'eco_msgs)))
  "Returns full string definition for message of type 'eco_msgs"
  (cl:format cl:nil "string type # type of robot “ECOLOGY20”~%string ip # address of the robot ESP8866~%uint32 port # Port for comunication~%uint8 id # identyti of robot a uint8_t~%uint8 inst_before # the last instruction runner ~%float32 battery # % of the battery~%uint16 range_l # ir sensor~%uint16 range_c # laser sensor~%uint16 range_r # ir sensor ~%int16 compas   # heading~%int16 pos_motor1 # position motor left~%int16 pos_motor2 # position motor right ~%arena_msgs/camera jevois # Aruco info~%string status # \"Completed\" or \"Error tipo 1\"~%~%================================================================================~%MSG: arena_msgs/camera~%int8 detect # 1 detect 0 non detect    ~%uint8 id    # number of fiducial~%int16 targx # coordinate x~%int16 targy # coordinate y~%string data # all info in string~%~%"))
