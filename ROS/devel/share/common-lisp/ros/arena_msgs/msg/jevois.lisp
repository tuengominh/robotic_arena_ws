...
(cl:defmethod cl:initialize-instance :after ((m <jevois>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'jevois)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arena_msgs-msg:<jevois> is deprecated: use arena_msgs-msg:jevois instead.")))
...
(cl:defmethod targw-val ((m <jevois>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:targw-val is deprecated.  Use arena_msgs-msg:targw instead.")
  (targw m))

(cl:ensure-generic-function 'targh-val :lambda-list '(m))
(cl:defmethod targh-val ((m <jevois>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:targh-val is deprecated.  Use arena_msgs-msg:targh instead.")
  (targh m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<jevois>)))
  ...
  (cl:format cl:nil "string type~%uint8 id~%int16 targx #coordinate x~%int16 targy #coordinate y~%int16 targw # weight of fiducial~%int16 targh # hight of fiducial~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'jevois)))
  "Returns full string definition for message of type 'jevois"
  (cl:format cl:nil "string type~%uint8 id~%int16 targx #coordinate x~%int16 targy #coordinate y~%int16 targw # weight of fiducial~%int16 targh # hight of fiducial~%~%~%"))
