...
(cl:defmethod cl:initialize-instance :after ((m <lidar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arena_msgs-msg:<lidar> is deprecated: use arena_msgs-msg:lidar instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <lidar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:position-val is deprecated.  Use arena_msgs-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <lidar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arena_msgs-msg:range-val is deprecated.  Use arena_msgs-msg:range instead.")
  (range m))
