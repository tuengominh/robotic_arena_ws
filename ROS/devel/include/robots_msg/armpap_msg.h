// Generated by gencpp from file robots_msg/armpap_msg.msg
// DO NOT EDIT!


#ifndef ROBOTS_MSG_MESSAGE_ARMPAP_MSG_H
#define ROBOTS_MSG_MESSAGE_ARMPAP_MSG_H
...
struct armpap_msg_
{
  typedef armpap_msg_<ContainerAllocator> Type;
  ...
  armpap_msg_(const ContainerAllocator& _alloc)
    : type(_alloc)
    , ip(_alloc)
    , port(0)
    , id(0)
  ...
  typedef boost::shared_ptr< ::robots_msg::armpap_msg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robots_msg::armpap_msg_<ContainerAllocator> const> ConstPtr;

}; // struct armpap_msg_

typedef ::robots_msg::armpap_msg_<std::allocator<void> > armpap_msg;

typedef boost::shared_ptr< ::robots_msg::armpap_msg > armpap_msgPtr;
typedef boost::shared_ptr< ::robots_msg::armpap_msg const> armpap_msgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robots_msg::armpap_msg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robots_msg::armpap_msg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robots_msg::armpap_msg_<ContainerAllocator1> & lhs, const ::robots_msg::armpap_msg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::robots_msg::armpap_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robots_msg::armpap_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robots_msg::armpap_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robots_msg::armpap_msg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robots_msg::armpap_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robots_msg::armpap_msg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robots_msg::armpap_msg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robots_msg::armpap_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x040948e8a15d597eULL;
  static const uint64_t static_value2 = 0x107b2f1c93f40e51ULL;
};

template<class ContainerAllocator>
struct DataType< ::robots_msg::armpap_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robots_msg::armpap_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robots_msg::armpap_msg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robots_msg::armpap_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robots_msg::armpap_msg_<ContainerAllocator>& v)
  {
    s << indent << "type: ";
...
#endif // ROBOTS_MSG_MESSAGE_ARMPAP_MSG_H
