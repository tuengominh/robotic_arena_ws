// Generated by gencpp from file robots_msg/tanke_msg.msg
// DO NOT EDIT!


#ifndef ROBOTS_MSG_MESSAGE_TANKE_MSG_H
#define ROBOTS_MSG_MESSAGE_TANKE_MSG_H
...
struct tanke_msg_
{
  typedef tanke_msg_<ContainerAllocator> Type;
  ...
  tanke_msg_(const ContainerAllocator& _alloc)
    : type(_alloc)
    , ip(_alloc)
    , port(0)
    , id(0)
  ...
  _motor1_type motor1;
   ...
   typedef  ::robots_msg::motor_<ContainerAllocator>  _motor3_type;
  _motor3_type motor3;

   typedef  ::robots_msg::motor_<ContainerAllocator>  _motor2_type;
  _motor2_type motor2;

   typedef  ::robots_msg::motor_<ContainerAllocator>  _motor4_type;
  _motor4_type motor4;
  ...
  _sensor_lidar_type sensor_lidar;
   ...
   typedef  ::robots_msg::platform_<ContainerAllocator>  _plat_type;
  _plat_type plat;
  ...
  typedef boost::shared_ptr< ::robots_msg::tanke_msg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robots_msg::tanke_msg_<ContainerAllocator> const> ConstPtr;

}; // struct tanke_msg_

typedef ::robots_msg::tanke_msg_<std::allocator<void> > tanke_msg;

typedef boost::shared_ptr< ::robots_msg::tanke_msg > tanke_msgPtr;
typedef boost::shared_ptr< ::robots_msg::tanke_msg const> tanke_msgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robots_msg::tanke_msg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robots_msg::tanke_msg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robots_msg::tanke_msg_<ContainerAllocator1> & lhs, const ::robots_msg::tanke_msg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::robots_msg::tanke_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robots_msg::tanke_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robots_msg::tanke_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robots_msg::tanke_msg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robots_msg::tanke_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robots_msg::tanke_msg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robots_msg::tanke_msg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robots_msg::tanke_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x12f0edb48ed4bd04ULL;
  static const uint64_t static_value2 = 0xea82e5f45e0f4635ULL;
};

template<class ContainerAllocator>
struct DataType< ::robots_msg::tanke_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robots_msg::tanke_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robots_msg::tanke_msg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robots_msg::tanke_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robots_msg::tanke_msg_<ContainerAllocator>& v)
  {
    s << indent << "type: ";
    ...
    s << indent << "motor3: ";
    s << std::endl;
    Printer< ::robots_msg::motor_<ContainerAllocator> >::stream(s, indent + "  ", v.motor3);
    s << indent << "motor2: ";
    s << std::endl;
    Printer< ::robots_msg::motor_<ContainerAllocator> >::stream(s, indent + "  ", v.motor2);
    s << indent << "motor4: ";
    s << std::endl;
    Printer< ::robots_msg::motor_<ContainerAllocator> >::stream(s, indent + "  ", v.motor4);
    s << indent << "camera: ";
    s << std::endl;
    ...
    s << indent << "plat: ";
    s << std::endl;
    Printer< ::robots_msg::platform_<ContainerAllocator> >::stream(s, indent + "  ", v.plat);
    s << indent << "status: ";
...
#endif // ROBOTS_MSG_MESSAGE_TANKE_MSG_H
