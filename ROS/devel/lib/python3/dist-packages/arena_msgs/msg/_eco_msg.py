...
"""autogenerated by genpy from arena_msgs/eco_msg.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['string','string','uint32','uint8','uint8','float32','float32','uint16','uint16','arena_msgs/motor','arena_msgs/motor','arena_msgs/jevois','arena_msgs/lidar','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.motor1 is None:
        self.motor1 = arena_msgs.msg.motor()
      if self.motor2 is None:
        self.motor2 = arena_msgs.msg.motor()
      if self.camera is None:
        self.camera = arena_msgs.msg.jevois()
      if self.sensor_lidar is None:
        self.sensor_lidar = arena_msgs.msg.lidar()
