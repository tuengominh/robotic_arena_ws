...
"""autogenerated by genpy from arena_msgs/ProcessDeviceActionResult.msg. Do not edit."""
import codecs
import sys
...
class ProcessDeviceActionResult(genpy.Message):
  _md5sum = "86fa1c7247bb90f552c8b754b49c4d4d"
  _type = "arena_msgs/ProcessDeviceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arena_msgs/ProcessDeviceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ProcessDeviceActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = arena_msgs.msg.ProcessDeviceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = arena_msgs.msg.ProcessDeviceResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.state,) = _get_struct_b().unpack(str[start:end])
      return self
