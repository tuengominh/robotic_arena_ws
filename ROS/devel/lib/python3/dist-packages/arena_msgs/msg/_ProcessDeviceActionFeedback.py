...
"""autogenerated by genpy from arena_msgs/ProcessDeviceActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ProcessDeviceActionFeedback(genpy.Message):
  _md5sum = "2a5484df2de89ee3bc6d42113420d5ea"
  _type = "arena_msgs/ProcessDeviceActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arena_msgs/ProcessDeviceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ProcessDeviceActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = arena_msgs.msg.ProcessDeviceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = arena_msgs.msg.ProcessDeviceFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_b2I().pack(_x.feedback.state, _x.feedback.completion_estimate.secs, _x.feedback.completion_estimate.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.state, _x.feedback.completion_estimate.secs, _x.feedback.completion_estimate.nsecs,) = _get_struct_b2I().unpack(str[start:end])
      return self
