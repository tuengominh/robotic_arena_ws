...
"""autogenerated by genpy from robots_msg/resource.msg. Do not edit."""
import codecs
import sys
...
class resource(genpy.Message):
  _md5sum = "5cf0b9aa0750781892e023b6ab9304df"
  _type = "robots_msg/resource"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string id  
string type
float32 impact
"""
  __slots__ = ['id','type','impact']
